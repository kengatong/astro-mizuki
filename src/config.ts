...
export const siteConfig: SiteConfig = {
	...
	banner: {
		...
		src: {
			desktop: [
				"/assets/desktop-banner/yun-jing.png",
				"/assets/desktop-banner/shao-nv.png",
				"/assets/desktop-banner/qiao-bian.png",
				"/assets/desktop-banner/zhizi.png",
				"/assets/desktop-banner/WLOP-云虫.png",
			], // 桌面横幅图片
			mobile: [
				"/assets/mobile-banner/taijie-tiqin.png",
				"/assets/mobile-banner/xiaoxin-xiyang.png",
				"/assets/mobile-banner/zhentan-kenan.png",
			], // 移动横幅图片
		}, // 使用本地横幅图片
		...
		homeText: {
			...
			title: "生命因何而沉睡", // 主页横幅主标题

			subtitle: [
				"飞蛾扑火，向死而生",
				"我们尚未知道这一问题的答案，就已经要从梦中醒来",
				"或许答案本身并不重要，重要的是自身的足迹",
			],
			typewriter: {
...
export const profileConfig: ProfileConfig = {
	avatar: "assets/images/avatar-3.png", // 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录
	name: "Kenga",
	bio: "生命因何而沉睡",
	links: [
		{
		...
		},
		{
			name: "Gitee",
			icon: "mdi:git",
			url: "https://gitee.com/Ringkenga",
		},
		{
			name: "GitHub",
			icon: "fa6-brands:github",
			url: "https://github.com/kengatong",
		},
		{
			name: "Discord",
...
export const pioConfig: import("./types/config").PioConfig = {
	...
	dialog: {
		...
		link: "https://github.com/404.html", // 关于链接 // 后期配置一个404页面
	},
};
