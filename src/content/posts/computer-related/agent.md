...
### 节点
通过使用代理服务器，以此来达到访问外部网络的目的。[SSONE](https://m.ssonestop.com/register?aff=LaaPMVbF)是一个比较不错的代理服务，节点多，网络传输速度也很快，很稳定，而且它的最低订阅也很便宜。当你订阅之后，只需要将其首页的订阅地址导入到代理软件中，就能够使用此项服务。
...
![](../../assets/images/agent-1.png)
### 客户端
	将订阅的地址复制，然后打开Clash Verge
![](../../assets/images/agent-2.png)

	选择订阅选项卡，将复制的地址粘贴到订阅栏中，随后点击导入

![](../../assets/images/agent-3.png)
